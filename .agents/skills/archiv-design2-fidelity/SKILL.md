...
- Passende, repraesentative Testdaten nur in `.Codex-test-home` und
  `.Codex-test-wiki` verwenden.
...
`AGENTS.md` festgelegte HOME-/XDG-Schema fuer `.Codex-test-home` und waehle
ausschliesslich `.Codex-test-wiki`.
