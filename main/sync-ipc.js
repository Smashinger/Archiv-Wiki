...
// Diagnoseberichte benötigen ausschließlich den technischen Laufzeitstatus,
// niemals Konfliktpfade oder andere projektbezogene Nutzerdaten. Deshalb
// wird hier bewusst nur eine reduzierte, rein technische Momentaufnahme
// exportiert statt des vollständigen currentStatus-Objekts.
function getSyncStatusSnapshot() {
  return {
    state: currentStatus.state,
    lastSyncAt: currentStatus.lastSyncAt,
    lastError: currentStatus.lastError,
    conflictCount: currentStatus.conflictCount || 0,
