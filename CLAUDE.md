# Archiv-Wiki – verbindliche Regeln für Claude Code
...
- Frühere Claude-Web-Sitzungen dürfen nur als Gesprächskontext verwendet werden.
...
- Testprofil:
  `/home/smashii/Dokumente/Archiv Wiki/archiv-wiki/.claude-test-home`

- Test-Wiki:
  `/home/smashii/Dokumente/Archiv Wiki/archiv-wiki/.claude-test-wiki`
...
HOME="$PWD/.claude-test-home" \
XDG_CONFIG_HOME="$PWD/.claude-test-home/.config" \
XDG_CACHE_HOME="$PWD/.claude-test-home/.cache" \
XDG_DATA_HOME="$PWD/.claude-test-home/.local/share" \
npm run dev
